...
function renderQuestion(){
	...
	if(pos >= questions.length){
		test.innerHTML = "<h3 class='you-got'>You can click on 'Review' button to check wrongly attempted questions.<BR><span class='ans'>"+correct+"</span> of <span class='length'>"+questions.length+"</span> questions are correct.<br><BR>Number of wrong questions  = "+wrongcount+"";
		_("test_status").innerHTML = "<BR>Test Completed in <U>" + timeTaken +" Minutes </U><br></h3>";
...
var ID;
	...
	chC = toTitleCase(questions[pos][3]);
	chD = toTitleCase(questions[pos][4]);
	right =toTitleCase(questions[pos][5]);
    wrong =toTitleCase( questions[pos][6]);
//alert(wrong);
...
table.setAttribute('border','1')
	...
	wrong=total-correct;
	var wrongpercent=0,rightpercent=0;
	wrongpercent=(wrong/total)*100;
	rightpercent=(correct/total)*100;
