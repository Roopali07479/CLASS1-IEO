var pos = 0, wrongpos=0,str='hello',wrongcount=0, wrongcountrepeat=0,test,CorrectAnswer, urChoice,test_status, question, choice, choices, chA, chB, chC,chD, correct = 0;
...
wrong = choice;
//alert(wrong);
printColors(right,wrong);

}
 
 
 function printColors(right,wrong){
	 //alert("Why not");
...
//alert('go green');
			if(wrong =="A")
				...
				test.innerHTML = "<h3 class='ques'>"+question+"</h3>";
				test.innerHTML += "<div class='answer-row'><input type='radio' name='choices' value='A'  id='A' >"+chA+"</div>";
				test.innerHTML += "<div class='answer-row green-ans'><input type='radio' name='choices'  checked='checked value='B' id='B'><span>"+chB+"</span></div>";
				test.innerHTML += "<div class='answer-row'><input type='radio' name='choices' value='C' id='C'>"+chC+"</div>";
				test.innerHTML += "<div class='answer-row'><input type='radio' name='choices' value='D' id='D''><span>"+chD+"</span></div>";
...
window.onload=function() {
     radBtns = document.getElementsByName('choices');
	 ////alert('here');
}
...
function renderQuestion(){
	...
	if(pos >= questions.length){
		...
		//test.innerHTML += "<button onclick='DetailAnalysis()' id='visit_return_button' class='review-text-btn'>Detail Result</button>";
...
else
{
	...
	test.innerHTML += "<div class='answer-row'><input type='radio' name='choices' value='A' onclick='clickAction(this);'><span  id = 'A'  onclick='clickAction(this);' >"+chA+"</span></div>";
	test.innerHTML += "<div class='answer-row'><input type='radio' name='choices' value='B'  onclick='clickAction(this);' ><span  id = 'B'  onclick='clickAction(this);' >"+chB+"</span></div>";
	test.innerHTML += "<div class='answer-row'><input type='radio' name='choices' value='C' onclick='clickAction(this);' ><span id = 'C'  onclick='clickAction(this);' >"+chC+"</span></div>";
	test.innerHTML += "<div class='answer-row'><input type='radio' name='choices' value='D' onclick='clickAction(this);' ><span  id = 'D' onclick='clickAction(this);' >"+chD+"</span></div>";
...
function DetailAnalysis(){
	str='8377971741';
	  if (str == "") {
		...
		alert(str);
        xmlhttp.open("GET","http://localhost/olympiad/first.php?q="+str,true);
        xmlhttp.send();
    }	
}*/
